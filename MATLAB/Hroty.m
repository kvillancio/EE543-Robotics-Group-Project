function [HTM] = Hroty(theta)
% Hroty(theta) converts a rotation angle (radians) into a
...
% i.e. a Homogeneous Rotation Matrix. The rotation axis is pre-selected as the Y axis,
...
HTM = [roty(theta), zeros(3,1); zeros(1,3), 1];
