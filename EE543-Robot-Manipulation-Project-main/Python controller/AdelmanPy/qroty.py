...
def qroty(angle: float) -> np.ndarray:
    """
    Calculate the quaternion representation of a rotation around the y-axis.

    This function computes the quaternion corresponding to a rotation of
    'angle' radians around the y-axis.
    ...
    Description:
        ...
        around the y-axis. The quaternion is returned in scalar-first format.
