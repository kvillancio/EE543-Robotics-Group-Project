...
def qrotz(angle: float) -> np.ndarray:
    """
    Calculate the quaternion representation of a rotation around the z-axis.

    This function computes the quaternion corresponding to a rotation of
    'angle' radians around the z-axis.
    ...
    Description:
        ...
        around the z-axis. The quaternion is returned in scalar-first format.
